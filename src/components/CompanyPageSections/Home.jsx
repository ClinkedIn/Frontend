...
const CompanyHomePage = () => {
  ...
  return(
    ...
    <div className="mt-4 bg-white   w-full rounded-lg shadow-lg p-4 ">
        ...
        {companyInfo?.tagLine  &&<h2 className="text-gray-500 ">{companyInfo.tagLine}</h2>}
        {companyInfo?.website  &&
        (<><h2 className="font-semibold ">Website</h2><a href={companyInfo.website} className="text-[#0A66C2] hover:underline" link={companyInfo.website} target="_blank" rel="noopener noreferrer">{companyInfo.website}</a></>
        )}
