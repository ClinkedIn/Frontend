  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-white">
      <div className="w-full max-w-7xl py-4 flex justify-between items-center pt-1">
        <div
          className="flex items-center text-[32px] font-bold text-gray-800 hover:cursor-pointer"
      ...
      <div className="flex justify-center flex-grow px-12 mb-12">
        <div className="bg-white lg:rounded-lg shadow-[5px_10px_20px_rgba(0,0,0,0.2)] p-6 w-[450px] h-[400px] mt-12">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              {errorMessage && (
                <p className="text-red-600 text-md mb-[-28px] mt-[-15px] ml-[10px]">
                  {errorMessage}
                </p>
              )}
            </div>
